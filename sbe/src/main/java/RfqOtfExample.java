...
public class RfqOtfExample {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        ByteBuffer encodedMsgBuffer = readFile(RfqExample.FILE_PATH);
        encodedMsgBuffer.position(encodedMsgBuffer.limit());
    ...
    private static ByteBuffer readFile(final String filePath) throws IOException {
        ...
        try {
            ...
            System.err.println("You need to run " + RfqExample.class.getCanonicalName() +
                    " first in order to generate the serialised file");
    ...
    private static void encodeSchema(final ByteBuffer byteBuffer) throws Exception {
        final Path path = Paths.get("sbe/src/main/resources/example-rfq.xml");
